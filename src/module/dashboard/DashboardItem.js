...
const DashboardItem = ({
  ...
  return (
    <div
      className={` w-full border border-blue-500 h-[150px] bg-[${bg}] rounded-lg relative dashboard-content`}
    >
      ...
      <button
        className={`absolute font-semibold text-white bottom-0 left-[50%] -translate-x-[50%] w-full h-[32px] bg-[${btnBg}]`}
